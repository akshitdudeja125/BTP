...
#define _nstates15	588	/* eventualLeadership */
#define minseq15	14953
#define maxseq15	15539
#define _endstate15	587

#define _nstates14	9	/* majorityAlive */
#define minseq14	14945
#define maxseq14	14952
#define _endstate14	8

#define _nstates13	41	/* recoveryLogConsistency */
#define minseq13	14905
#define maxseq13	14944
#define _endstate13	40

#define _nstates12	41	/* crashedNoMessages */
#define minseq12	14865
#define maxseq12	14904
#define _endstate12	40

#define _nstates11	11	/* noCrashedLeader */
#define minseq11	14855
#define maxseq11	14864
#define _endstate11	10

#define _nstates10	71	/* leaderCompleteness */
#define minseq10	14785
#define maxseq10	14854
#define _endstate10	70

#define _nstates9	11	/* stateMachineSafety */
#define minseq9	14775
#define maxseq9	14784
#define _endstate9	10

#define _nstates8	11	/* logMatching */
#define minseq8	14765
#define maxseq8	14774
#define _endstate8	10

#define _nstates7	4791	/* leaderAppendOnly2 */
#define minseq7	9975
#define maxseq7	14764
#define _endstate7	4790

#define _nstates6	4791	/* leaderAppendOnly1 */
#define minseq6	5185
#define maxseq6	9974
#define _endstate6	4790

#define _nstates5	4791	/* leaderAppendOnly0 */
#define minseq5	395
#define maxseq5	5184
#define _endstate5	4790

#define _nstates4	28	/* eventualRecovery */
#define minseq4	368
#define maxseq4	394
#define _endstate4	27

#define _nstates3	21	/* crashSafety */
#define minseq3	348
#define maxseq3	367
#define _endstate3	20

#define _nstates2	11	/* electionSafety */
#define minseq2	338
#define maxseq2	347
...
#define _nstates0	325	/* server */
#define minseq0	0
#define maxseq0	323
#define _endstate0	324
...
typedef struct P15 { /* eventualLeadership */
...
typedef struct P14 { /* majorityAlive */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P13 { /* recoveryLogConsistency */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P12 { /* crashedNoMessages */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P11 { /* noCrashedLeader */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P10 { /* leaderCompleteness */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P9 { /* stateMachineSafety */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P7 { /* leaderAppendOnly2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P6 { /* leaderAppendOnly1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P5 { /* leaderAppendOnly0 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* eventualRecovery */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P2 { /* electionSafety */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 14; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P17 {
	...
	unsigned _p   : 14; /* active-claim state */
...
#else
	#define ACCEPT_LAB	180 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
